                ...
                <Col span={24}>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: editMode,
                        message: "Please enter minimum age",
                      },
                      ({ getFieldValue }) => ({
                        validator(_, value) {
                          ...
                          if (value.length > 0 && isNaN(value))
                            return Promise.reject(
                              new Error("must type number")
                            );
                          if (parseInt(value)) {
                            let i = parseInt(value);
                            if (i > 150 || i < 10)
                              return Promise.reject(new Error("[10,150]"));
                ...
                <Col span={24}>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: editMode,
                        message: "Please enter maximum age",
                      },
                      ({ getFieldValue }) => ({
                        validator(_, value) {
                          if (!editMode) return Promise.resolve();
                      ...
                      ({ getFieldValue }) => ({
                        validator(_, value) {
                          ...
                          if (parseInt(value)) {
                            let i = parseInt(value);
                            if (i > 50 || i < 20)
                              return Promise.reject(new Error("[20,50]"));
                            return Promise.resolve();
                          }
                          return Promise.reject();
                        },
                ...
                <Col span={24}>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: editMode,
                        message: "Please enter maximum score",
                      },
                      ({ getFieldValue }) => ({
                        validator(_, value) {
                          if (!editMode) return Promise.resolve();
                ...
                <Col span={24}>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: editMode,
                        message: "Please enter subject passing score",
                      },
                      ({ getFieldValue }) => ({
                        validator(_, value) {
                          if (!editMode) return Promise.resolve();
